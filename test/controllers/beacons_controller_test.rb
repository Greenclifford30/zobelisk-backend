...
class BeaconsControllerTest < ActionController::TestCase
  ...
  test "should create beacon" do
    assert_difference('Beacon.count') do
      post :create, beacon: { beacon: @beacon.beacon, lat: @beacon.lat, long: @beacon.long, name: @beacon.name }
    end
  ...
  test "should update beacon" do
    patch :update, id: @beacon, beacon: { beacon: @beacon.beacon, lat: @beacon.lat, long: @beacon.long, name: @beacon.name }
    assert_redirected_to beacon_path(assigns(:beacon))
  end
